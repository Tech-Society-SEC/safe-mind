  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Curated playlists to support your emotional wellbeing</p>
      </div>
        ...
        <div className="space-y-2">
          {filteredSongs.map((song, index) => (
            ...
            >
              ...
              >
                {playingSong === song.title ? <Pause className="h-4 w-4" /> : <Play className="h-4 w-4" />}
              </Button>
              ...
              <Button
                ...
                className={cn(
                  "h-8 w-8",
                  song.loved ? "text-secondary-accent hover:text-secondary-accent/80" : "text-muted-foreground hover:text-secondary-accent"
                )}
              >
